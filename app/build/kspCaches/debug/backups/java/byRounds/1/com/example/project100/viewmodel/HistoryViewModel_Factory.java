...
public final class HistoryViewModel_Factory implements Factory<HistoryViewModel> {
  ...
  public HistoryViewModel_Factory(Provider<WorkoutRepository> repositoryProvider) {
  ...
  public static HistoryViewModel_Factory create(Provider<WorkoutRepository> repositoryProvider) {
    return new HistoryViewModel_Factory(repositoryProvider);
  }

  public static HistoryViewModel newInstance(WorkoutRepository repository) {
