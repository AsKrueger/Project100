...
public final class TrainingViewModel_HiltModules_KeyModule_ProvideFactory implements Factory<Boolean> {
  @Override
  public Boolean get() {
    return provide();
  }
  ...
  public static boolean provide() {
    return TrainingViewModel_HiltModules.KeyModule.provide();
  }
